...
student_data_path = 'F:/Data/student_dataset_large_with_grades.csv'
courses_data_path = 'F:/Data/Coursera_courses_catalog.csvfiltered_courses.csv'

# Load the datasets
student_data = pd.read_csv(student_data_path)
courses_data = pd.read_csv(courses_data_path)
